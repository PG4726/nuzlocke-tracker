// typedata.js — Pokémon type lookup
// 📁 Save as: public/typedata.js
// Load BEFORE app.js in index.html
//
// POKEMON_TYPES: species name (title case) → [type1] or [type1, type2]
// TYPE_COLORS: type name → background colour (cyberpunk-friendly but type-accurate)
...
// Returns type array for a species, or [] if unknown
function getPokemonTypes(species) {
  return POKEMON_TYPES[species] || [];
}

// Returns inline style string for a type badge
